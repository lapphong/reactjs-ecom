...
export default function ShoppingList() {
   ...
   const itemSelector = useSelector(items);
   ...
   const topRatedItems = itemSelector.filter(
      (item) => item.attributes.category === 'topRated',
   );
   const newArrivalsItems = itemSelector.filter(
      (item) => item.attributes.category === 'newArrivals',
   );
   const bestSellersItems = itemSelector.filter(
